...
public class AddRuleActivity extends Activity {
    ...
    public void addRule(View view) {
        ...
        else if(etFormula.getText().length()==0)
        {
            msgError+= "You must fill reclamation body\n";
        }
        else
    ...
    {
        WebServiceTask wst = new WebServiceTask(WebServiceTask.POST_TASK, this, "Adding Rule...");



        wst.addNameValuePair("name", etName.getText().toString());
        wst.addNameValuePair("description", etDescription.getText().toString());
        wst.addNameValuePair("formule", etFormula.getText().toString());
        wst.addNameValuePair("adminEmail", new Session().getAdmin().getEmail());
